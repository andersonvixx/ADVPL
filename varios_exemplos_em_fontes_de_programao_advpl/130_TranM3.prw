...
dbSelectArea("SX3")
dbSetOrder(1)
dbSeek(cAlias2)                                                                     //Lê o sx3 e procura o SC6

While !SX3->(EOF()) .And. SX3->X3_Arquivo == cAlias2                                //Para montar o array com todos os itens disponiveis naquele Alias
   ...
   While !EOF() .And. (cAlias2)->C6_Filial == xFilial(cAlias2) .And. (cAlias2)->C6_NUM== (cAlias1)->C5_NUM
      ...
      For i := 1 To nQtdCpo
          If aHeader[i][10] <> "V"
             ...
             aCols[nCols][i] := &("(cAlias2)->"+aHeader[i][2])        //forma mais fácil utilizando macro, quero o conteudo do C6_item
           Else
