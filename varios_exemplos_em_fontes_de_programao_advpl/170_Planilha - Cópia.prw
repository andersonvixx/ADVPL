...
// ou
// =MSGetArray(A1,Siga("U_PLANMOV(p1,p2,pN)")) --> passando parametros para a funcao. A funcao deverá receber os parametros.
//
...
// A funcao poderá receber parametros: User Function PlanMOV(p1,p2,pN)
